    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('number', models.DateField(blank=True, verbose_name='Number')),
                ('is_active', models.BooleanField(blank=True, default=True, verbose_name='Active')),
                ('room_type', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='product.product')),
